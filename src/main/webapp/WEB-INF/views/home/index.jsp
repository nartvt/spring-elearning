	...
	<div class="carousel">
		<div class="carousel-caption">
			<div class="container-fluid">
				...
				<div class="caption-text">Study any topic, anytime. Choose
					from thousands of expert-led courses now.</div>
		...
		<div class="row">
			<div class="col-md-4 pb-4 pt-5">
				<div class="h-100 best-seller-sologan">
					<div class="px-5">
						<h5 class="font-weight-bold">The world’s largest selection of
							courses</h5>
						<p>Choose from over 100,000 online video courses with new
					...
					<c:forEach begin="1" end="4">
						<div class="col-md-3">
							<div class="course">
								...
								<h6 class="course-title">The Complete Digital Marketing
									Course - 12 Courses in 1</h6>
								<small class="course-content"> Become an ethical hacker
									that can hack computer systems like black hat hackers and
									secure them like security experts. </small>
								...
								<div class="course-overlay">
									<a href="details.html">
										...
										<div class="course-info">
											<span><i class="fa fa-play-circle"></i> 180 lectures</span> <span
												class="mx-1"> | </span> <span><i
												class="fa fa-clock-o"></i> 40 hours</span>
										</div> <small class="course-content"> Become an ethical
											hacker that can hack computer systems like black hat hackers
											and secure them like security experts. </small>
									</a> <a href="#" class="btn btn-sm btn-danger text-white w-100">Add
										to cart</a>
								</div>
							</div>
						</div>
				...
				<div class="col-md-2">
					<div class="course">
						...
						<h6 class="course-title">The Complete Digital Marketing
							Course - 12 Courses in 1</h6>
						<small class="course-content"> Become an ethical hacker
							that can hack computer systems like black hat hackers and secure
							them like security experts. </small>
						<div class="course-price">
						...
						<div class="course-overlay">
							<a href="details.html">
								...
								<div class="course-info">
									<span><i class="fa fa-play-circle"></i> 180 lectures</span> <span
										class="mx-1"> | </span> <span><i class="fa fa-clock-o"></i>
										40 hours</span>
								</div> <small class="course-content"> Become an ethical hacker
									that can hack computer systems like black hat hackers and
									secure them like security experts. </small>
							</a> <a href="#" class="btn btn-sm btn-danger text-white w-100">Add
								to cart</a>
...
<section class="categories">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a class="category"> <i class="fa fa-desktop"></i> <span>IT
						& Software</span>
				</a>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="feedback-item">
					...
					<div class="feedback-content">Elearning is a life saver. I
						don't have the time or money for a college education. My goal is
						to become a freelance web developer, and thanks to Udemy, I'm
						really close.</div>
				</div>
			</div>
			<div class="col-md-4">
