...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css"
      href="<c:url value='/statics/admin/bower_components/bootstrap/css/bootstrap.min.css'/>">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            ...
            <form action="${ action }" method="post" id="frmLogin">
              ...
              <div class="auth-box card">
                <div class="card-block">
                  ...
                  <div class="row m-t-30">
                    ...
                    <div class="col-md-4">
                      <c:url value="/admin/login" var="roleUrl" /> or you are not have account <button
                        class="btn btn-danger ml-2" id="btnSignUp" data-id="${roleUrl}">Sign up</button> now </div>
                  </div>
                </div>
              </div>
            </form>
