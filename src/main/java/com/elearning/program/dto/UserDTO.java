...
public class UserDTO {
  ...
  public UserDTO(String userId, String email, String fullname, String password, String avatar, String phone,
      String address, String personType, String website, String facebook, String roleId) {
    this.userId = userId;
    this.email = email;
